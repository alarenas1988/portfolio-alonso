...
select ok(not has_table_privilege('anon', 'public.site_settings', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.site_settings', 'SELECT,INSERT,UPDATE,DELETE'), 'site_settings: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.contact_settings'::regclass), 'contact_settings: RLS enabled');
select ok(not has_table_privilege('anon', 'public.contact_settings', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.contact_settings', 'SELECT,INSERT,UPDATE,DELETE'), 'contact_settings: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.social_links'::regclass), 'social_links: RLS enabled');
select ok(not has_table_privilege('anon', 'public.social_links', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.social_links', 'SELECT,INSERT,UPDATE,DELETE'), 'social_links: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.projects'::regclass), 'projects: RLS enabled');
select ok(not has_table_privilege('anon', 'public.projects', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.projects', 'SELECT,INSERT,UPDATE,DELETE'), 'projects: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.project_features'::regclass), 'project_features: RLS enabled');
select ok(not has_table_privilege('anon', 'public.project_features', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.project_features', 'SELECT,INSERT,UPDATE,DELETE'), 'project_features: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.project_images'::regclass), 'project_images: RLS enabled');
select ok(not has_table_privilege('anon', 'public.project_images', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.project_images', 'SELECT,INSERT,UPDATE,DELETE'), 'project_images: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.project_metrics'::regclass), 'project_metrics: RLS enabled');
select ok(not has_table_privilege('anon', 'public.project_metrics', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.project_metrics', 'SELECT,INSERT,UPDATE,DELETE'), 'project_metrics: no client grants in F5');
...
select ok(not has_table_privilege('anon', 'public.project_challenges', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.project_challenges', 'SELECT,INSERT,UPDATE,DELETE'), 'project_challenges: no client grants in F5');
...
select ok(not has_table_privilege('anon', 'public.project_technologies', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.project_technologies', 'SELECT,INSERT,UPDATE,DELETE'), 'project_technologies: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.posts'::regclass), 'posts: RLS enabled');
select ok(not has_table_privilege('anon', 'public.posts', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.posts', 'SELECT,INSERT,UPDATE,DELETE'), 'posts: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.post_categories'::regclass), 'post_categories: RLS enabled');
select ok(not has_table_privilege('anon', 'public.post_categories', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.post_categories', 'SELECT,INSERT,UPDATE,DELETE'), 'post_categories: no client grants in F5');
...
select ok(not has_table_privilege('anon', 'public.post_category_relations', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.post_category_relations', 'SELECT,INSERT,UPDATE,DELETE'), 'post_category_relations: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.tags'::regclass), 'tags: RLS enabled');
select ok(not has_table_privilege('anon', 'public.tags', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.tags', 'SELECT,INSERT,UPDATE,DELETE'), 'tags: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.post_tags'::regclass), 'post_tags: RLS enabled');
select ok(not has_table_privilege('anon', 'public.post_tags', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.post_tags', 'SELECT,INSERT,UPDATE,DELETE'), 'post_tags: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.experiences'::regclass), 'experiences: RLS enabled');
select ok(not has_table_privilege('anon', 'public.experiences', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.experiences', 'SELECT,INSERT,UPDATE,DELETE'), 'experiences: no client grants in F5');
...
select ok(not has_table_privilege('anon', 'public.experience_highlights', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.experience_highlights', 'SELECT,INSERT,UPDATE,DELETE'), 'experience_highlights: no client grants in F5');
...
select ok(not has_table_privilege('anon', 'public.experience_projects', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.experience_projects', 'SELECT,INSERT,UPDATE,DELETE'), 'experience_projects: no client grants in F5');
...
select ok(not has_table_privilege('anon', 'public.experience_technologies', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.experience_technologies', 'SELECT,INSERT,UPDATE,DELETE'), 'experience_technologies: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.technologies'::regclass), 'technologies: RLS enabled');
select ok(not has_table_privilege('anon', 'public.technologies', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.technologies', 'SELECT,INSERT,UPDATE,DELETE'), 'technologies: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.specialties'::regclass), 'specialties: RLS enabled');
select ok(not has_table_privilege('anon', 'public.specialties', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.specialties', 'SELECT,INSERT,UPDATE,DELETE'), 'specialties: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.work_principles'::regclass), 'work_principles: RLS enabled');
select ok(not has_table_privilege('anon', 'public.work_principles', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.work_principles', 'SELECT,INSERT,UPDATE,DELETE'), 'work_principles: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.impact_metrics'::regclass), 'impact_metrics: RLS enabled');
select ok(not has_table_privilege('anon', 'public.impact_metrics', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.impact_metrics', 'SELECT,INSERT,UPDATE,DELETE'), 'impact_metrics: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.media_assets'::regclass), 'media_assets: RLS enabled');
select ok(not has_table_privilege('anon', 'public.media_assets', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.media_assets', 'SELECT,INSERT,UPDATE,DELETE'), 'media_assets: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.media_references'::regclass), 'media_references: RLS enabled');
select ok(not has_table_privilege('anon', 'public.media_references', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.media_references', 'SELECT,INSERT,UPDATE,DELETE'), 'media_references: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.documents'::regclass), 'documents: RLS enabled');
select ok(not has_table_privilege('anon', 'public.documents', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.documents', 'SELECT,INSERT,UPDATE,DELETE'), 'documents: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.admin_profiles'::regclass), 'admin_profiles: RLS enabled');
select ok(not has_table_privilege('anon', 'public.admin_profiles', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.admin_profiles', 'SELECT,INSERT,UPDATE,DELETE'), 'admin_profiles: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.contact_messages'::regclass), 'contact_messages: RLS enabled');
select ok(not has_table_privilege('anon', 'public.contact_messages', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.contact_messages', 'SELECT,INSERT,UPDATE,DELETE'), 'contact_messages: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.analytics_events'::regclass), 'analytics_events: RLS enabled');
select ok(not has_table_privilege('anon', 'public.analytics_events', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.analytics_events', 'SELECT,INSERT,UPDATE,DELETE'), 'analytics_events: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.analytics_daily'::regclass), 'analytics_daily: RLS enabled');
select ok(not has_table_privilege('anon', 'public.analytics_daily', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.analytics_daily', 'SELECT,INSERT,UPDATE,DELETE'), 'analytics_daily: no client grants in F5');
...
select ok(not has_table_privilege('anon', 'public.analytics_daily_content', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.analytics_daily_content', 'SELECT,INSERT,UPDATE,DELETE'), 'analytics_daily_content: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.admin_activity'::regclass), 'admin_activity: RLS enabled');
select ok(not has_table_privilege('anon', 'public.admin_activity', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.admin_activity', 'SELECT,INSERT,UPDATE,DELETE'), 'admin_activity: no client grants in F5');
select ok((select relrowsecurity from pg_class where oid = 'public.site_builds'::regclass), 'site_builds: RLS enabled');
select ok(not has_table_privilege('anon', 'public.site_builds', 'SELECT,INSERT,UPDATE,DELETE') and not has_table_privilege('authenticated', 'public.site_builds', 'SELECT,INSERT,UPDATE,DELETE'), 'site_builds: no client grants in F5');
select ok(not has_function_privilege('anon','public.get_public_snapshot()','EXECUTE') and not has_function_privilege('authenticated','public.get_public_snapshot()','EXECUTE'), 'RPC execution closed until F6');
select is((select count(*) from pg_policies where schemaname in ('public','private')), 0::bigint, 'F5 does not install F6 policies');
select ok(not has_schema_privilege('anon','private','USAGE') and not has_schema_privilege('authenticated','private','USAGE'), 'Private schema inaccessible');
...
reset role;
set local role anon;
select throws_ok($test$select public.get_public_snapshot()$test$, '42501', null, 'Anon cannot execute RPC in F5');
...
select throws_ok($test$select public.get_public_snapshot()$test$, '42501', null, 'Authenticated cannot execute RPC in F5');
select throws_ok($test$select * from public.site_builds$test$, '42501', null, 'Authenticated cannot read builds');
reset role;
