...
La operación remota requiere puerta local aprobada, proyecto verificado, backup/inventario, diff completo y dry-run exclusivo de 022. Solo se despliega track-event; contact-submit conserva su versión. El estado y evidencia final de ejecución se registran en el checkpoint F10, sin valores de secrets.
